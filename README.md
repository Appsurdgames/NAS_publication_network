...
> Only papers are considered that have been during during the time period the researcher has been affliated with NAS or worked with a NAS members. Any papers outside this period are not considered.

> **Q: Do master students also appear in this list?**
> If they worked together with a NAS employee at that time and their work led to a publication, they will appear as author on that paper. As such, they will appear as "external researcher" in the tool.

> **Q: Are there any Joomla settings required?**
> Confirmed working in Joomla 6.0.2 with PHP 8.4.17. In Joomla, Excel files are not uploadable by default. They should be enabled first. In the left navigation bar, go to "Content" -> "Media". Click "Options" in the top-right corner. Allowed extensions: Add "xlsx". Legal Document Extensions (File Types): Add "xlsx". Legal MIME Types: Add "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
